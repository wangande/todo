...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoBox = __webpack_require__(160);

	ReactDOM.render(React.createElement(TodoBox, null), document.getElementById('mainNode'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoForm = __webpack_require__(164);
	...
	var TodoBox = React.createClass({
	    ...
	    // 根据id删除一项任务
	    handleTaskDelete: function handleTaskDelete(taskId) {
	        var self = this;
	        $.ajax({
	            url: "/todo/" + taskId,
	            traditional: true,
	    ...
	    // 切换一项任务的完成状态
	    handleToggleComplete: function handleToggleComplete(taskId) {
	        var self = this;
	        $.ajax({
	            url: "/todo/" + taskId,
	            traditional: true,
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                "div",
	                { style: formClass },
	                React.createElement(TodoForm, { submitTask: this.handleSubmit })
	            ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var ReactDOM = __webpack_require__(159);
	var TodoItem = __webpack_require__(162);
	var TodoFooter = __webpack_require__(163);
	...
	var TodoList = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            taskList,
	            React.createElement(TodoFooter, { todoCount: this.props.todoCount, todoCompleteCount: this.props.todoCompleteCount })
	        );
	    }
	});
	...
	var TodoItem = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement("input", { type: "checkbox", checked: itemChecked, onChange: this.toggleComplete, className: "pull-left" }),
	            task,
	            React.createElement(
	                "div",
	...
	var TodoForm = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                "form",
	                { className: "form-horizontal", onSubmit: this.submitTask },
	                React.createElement(
	                    "div",
	                    { className: "form-group" },
	                    React.createElement(
	                        "label",
	                        { htmlFor: "task", className: "col-md-1 control-label" },
	                        "任务"
	                    ),
	                    React.createElement(
	                        "div",
	                        { className: "col-md-8" },
	                        React.createElement("input", { type: "text", id: "task", ref: "task", className: "form-control", placeholder: "发布新任务" })
	                    ),
	                    React.createElement(
	                        "div",
	                        { className: "col-md-3 text-right" },
	                        React.createElement("input", { type: "submit", value: "发布", className: "btn btn-primary" })
	                    )
	                )
	            )
	        );
